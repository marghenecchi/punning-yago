...
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RDF/RDFS    | same IRI appears as class (object of P279 chains) and individual (subject of molecular formula, boiling point); domain/range inference fires on entity facts, potentially making H₂O an instance of the domain class | permissive           | no mechanism to distinguish the chemical kind (every molecule IS water) from the entity (this substance has CAS 7732-18-5); generic facts about chemical behaviour (reacts with X) are indistinguishable from entity facts |
| OWL 2       | explicit punning — H₂O as class (every water molecule is an instance) and individual (with formula, boiling point); domain inferences on the individual are isolated from the class extension                        | formally correct     | complex; molecules not represented anyway; generic chemical behaviour still inexpressible as a non-universal restriction                                                                                                   |
| Wikidata    | P31 + P279 co-exist; entity facts on the item                                                                                                                                                                        | pragmatic, data-rich | no single interpretation                                                                                                                                                                                                   |
| ChEBI       | chemicals are OWL classes; entity facts (formula, charge) are OWL annotation properties on the class — not ABox assertions                                                                                           | chemically rigorous  | annotation properties are not reasoned over; this is a third option (neither punning nor instance-model); complex for SPARQL                                                                                               |
